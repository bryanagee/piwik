...
class GenerateIntl extends ConsoleCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($piwikLanguages AS $langCode) {
            ...
            $this->fetchLanguageData($output, $langCode, $requestLangCode, $translations);
            $this->fetchTerritoryData($output, $langCode, $requestLangCode, $translations);
            $this->fetchCalendarData($output, $langCode, $requestLangCode, $translations);
